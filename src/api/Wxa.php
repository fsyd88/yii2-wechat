...
class Wxa extends WxBase {
    ...
    public function unbindTester($userstr) {
        return $this->post('wxa/bind_tester', ['userstr' => $userstr]);
    }
    ...
    public function addToTemplate($draft_id) {
        return $this->post('wxa/addtotemplate', ['draft_id' => $draft_id]);
    }
    ...
    public function deleteTemplate($template_id) {
        return $this->post('wxa/deletetemplate', ['template_id' => $template_id]);
    }

    /**
     * 上传小程序代码
     * @param number $template_id  代码库中的代码模版 ID
     * @param array $ext_json  第三方自定义的配置
    ...
    public function commit($template_id, $ext_json, $user_version, $user_desc) {
        return $this->post('wxa/commit', ['template_id' => $template_id, 'ext_json' => json_encode($ext_json), 'user_version' => $user_version, 'user_desc' => $user_desc]);
    }
